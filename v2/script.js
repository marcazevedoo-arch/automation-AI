...
(() => {
  ...
  function initStaggerReveal() {
    const groups = [
      ...
      { el: $('#sec-13'), reverse: false, initialDelay: 400 }
    ];
  ...
  function initSiteNav() {
    ...
    // Títulos do roteiro · versão 20 min — sentence case (13 slides + capa)
    const TITLES = {
      '00': 'Capa',
      '01': 'O sistema operacional',
      '02': 'O problema',
      '03': 'Publicis 5,8%',
      '04': '95% falham',
      '05': 'Agência = laboratório',
      '06': 'Reverse Discovery',
      '07': 'Modelo de negócio',
      '08': '60 dias + 6 meses',
      '09': 'Orçamento claro',
      '10': 'Riscos mitigados',
      '11': 'Liderança interna',
      '12': 'Os três pedidos',
    ...
    function setCurrent(idx) {
      ...
      // Top nav active — 4 atos cobrem os 13 slides (01–04, 05–08, 09–11, 12–13)
  ...
  /* ------------------------------------------------------------------------
     12. Speaker notes — notas de apresentação (Talking Track) por slide.
         Cada .section tem um <aside class="speaker-notes"> oculto. A tecla "N"
         alterna body.show-notes, que revela as notas do slide atual (.is-current)
         em um painel fixo. Pensado para o modo apresentador — não altera o
         visual público quando desligado.
     ------------------------------------------------------------------------ */
  function initSpeakerNotes() {
    if (!$$('.speaker-notes').length) return;
